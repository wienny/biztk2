...
String sCom_id = request.getParameter("p_com_id")== null ? "": request.getParameter("p_com_id");
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------
		// 업체 주문상품 전체 목록 조회 . 페이지 로딩 시 최초 1회. ajax call 
		//----------------------				
		getCompanyOrderAllList('<%=sCom_id%>');
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					COMPANY Information <small>태권도장 상세정보 및 주문내역입니다.</small>
					</h3>
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<th>
						<i class="fa fa-gift"></i> 품명
					</th>
					<th>
						<i class="fa fa-arrows"></i> 옵션
					</th>
					<th>
						<i class="fa fa-shopping-cart"></i> 수량
					</th>
					<th class="hidden-xs">
						<i class="fa fa-calendar"></i> 주문확정일자
					</th>															
