...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------
		// 업체 리스트 전체 조회 . 페이지 로딩 시 최초 1회. ajax call 
		//----------------------				
		getCompanyList();
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					COMPANY LIST <small>가입된 태권도장 목록입니다.</small>
					</h3>
			...
			<div class="portlet-body">
				...
				<tr>
					<th>
						<i class="fa fa-check"></i> 도장ID
					</th>
					<th>
						<i class="fa fa-globe"></i> 도장명칭
					</th>
					<th class="hidden-xs">
						<i class="fa fa-envelope"></i> 이메일
					</th>
					<th>
						<i class="fa fa-bar-chart-o"></i> 주문정보
					</th>					
