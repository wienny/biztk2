...
biz.getProductOptionInfo(sProduct_id);


ListData list = (ListData)request.getAttribute("productoptionlist");
if(list == null)
	sResult_count = "0";
else
...
if (list != null){
	...
	for(int i=0; i < list.size(); i++)	{
		...
		str.append("<item>");
		str.append("<option_id>"+row.get("option_id", "")+"</option_id>");
		str.append("<option_text>"+row.get("option_text", "")+"</option_text>");
		str.append("</item>");
	}
}
