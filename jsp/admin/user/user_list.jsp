...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------
		// 관원 전체목록 조회 . 페이지 로딩 시 최초 1회. ajax call 
		//----------------------				
		getUserList();
		
		//----------------------
		// 관원추가 버튼 클릭 시 post.  ajax call /lib/ajax_use.js
		//----------------------
		$('#useradd_btn').bind('click', function() {
			addUser();
		});
	...
	function viewAddUser(){
		var state = $('div[id=userinsert_form_div]').css('display');
		if(state=="none") {
			$('div[id=userinsert_form_div]').css('display','block');
			//$('div[id=div_menu_setting]').css('display','none');
		}
		else
			$('div[id=userinsert_form_div]').css('display','none');
	}		
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					USER List <small>등록된 관원 목록입니다.</small>
					</h3>
			...
			<div class="portlet-body">
				...
				<tr>
					<th class="hidden-xs">
						<i class="fa fa-check"></i> 관원ID
					</th>
					<th>
						<i class="fa fa-gift"></i> 관원
					</th>
					<!-- th class="hidden-xs">
						<i class="fa fa-gift"></i> 관원전화
					</th-->					
					<th>
						<i class="fa fa-sitemap"></i> 부모님
					</th>
					<th>
						<i class="fa fa-sitemap"></i> 부모님전화
					</th>					
...
<div class="portlet box blue" id="menu_tool_div">
	<div class="portlet-title">

	</div>
	<div class="portlet-body form">
		<form id="frmMenuInsert" class="form-horizontal">
		<div class="form-body">

				<div class="row">
					<div class="col-md-10">
						<div class="col-md-offset-4 col-md-29" id="menu_func_div">
							<div class="btn green" id="" onclick="viewAddUser();">사용자 등록</div>
							<!-- div class="btn red" id="menupause_btn" >Delete</div>
							<div class="btn default" id="menuup_btn" >Up</div>
							<div class="btn default" id="menudown_btn" >Down</div-->
						</div>
					</div>
					<div class="col-md-10">
					</div>
		       ...
		       <div class="portlet box yellow" id="userinsert_form_div" style="display:none;">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>User Add Form
							</div>
							<!-- div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="#" id="frmUserInsert" class="form-horizontal">
								<div class="form-body">
                                   ...
                                   <!----------------------------------------------------------------------BEGIN Form Data-------------------------------------------------------------------------------->     
                                    ...
                                    <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="hidden" name="p_com_id" value="<%=ss_com_id %>" />
													
													<input type="text" id="p_user_id"  name="p_user_id" class="form-control" placeholder="User ID"  onkeyup="checkUserID('p_user_id','user_check_div');" />
													<span id="user_check_div"></span>
												</div>
											</div>
										</div>
										<!--/span-->
                                    ...
                                    <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" id="p_user_pw"  name="p_user_pw" class="form-control" placeholder="Password"   />
													<!-- span id="user_check_div"></span-->
												</div>
											</div>
										</div>
                                    ...
                                    <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">관원명</label>
												<div class="col-md-10">													
													<input type="text" id="p_student_name" name="p_student_name" class="form-control" placeholder="Student Name" />
												</div>
											</div>
										</div>
										<!--/span-->
                                    ...
                                    <!-- div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">Student HP</label>
												<div class="col-md-10">													
													<input type="text" id="p_student_hp" name="p_student_hp" class="form-control" placeholder="01099990000" />
												</div>	
											</div>
										</div>
									</div-->
                                    ...
                                    <!-- div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">학부모님</label>
												<div class="col-md-10">													
													<input type="text" id="p_parent_name" name="p_parent_name" class="form-control" placeholder="Parent Name" />
												</div>
											</div>
										</div>
									</div-->
                                    ...
                                    <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">부모님 전화</label>
												<div class="col-md-10">													
													<input type="text" id="p_parent_hp" name="p_parent_hp" class="form-control" placeholder="01099990000" />
												</div>												
											</div>
										</div>
										<!--/span-->
									...
									<div class="row">
										<div class="col-md-6">
											<div class="col-md-offset-3 col-md-9">
												<div type="button" class="btn yellow" id="useradd_btn" style="display:none;">Submit</div>
