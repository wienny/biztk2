...
if(ss_com_id.equals("")) {
	out.println("<script>alert('아이고~~ 이거 행님이 로그인한 것이 아니구마~~ 로그인허쇼~!!');</script>");
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------
		// 상품 리스트 전체 조회 . 페이지 로딩 시 최초 1회. ajax call 
		//----------------------				
		getProductList();
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					PRODUCT List <small>등록된 상품 목록입니다.</small>
					</h3>
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<th class="hidden-xs">
						<i class="fa fa-sitemap"></i> 상품유형
					</th>
					<th class="hidden-xs">
						<i class="fa fa-calendar"></i> 상품등록일
					</th>	
					<th>
						<i class="fa fa-bar-chart-o"></i> 주문현황
					</th>
<%
	if(ss_com_type.equals("0") || ss_com_type.equals("1")) {
%>									
					<th>
