...
if(ss_com_id.equals("")) {
	ss_com_id = request.getParameter("com_id")== null ? "": request.getParameter("com_id").toString();
	ss_com_type = request.getParameter("com_type")== null ? "": request.getParameter("com_type").toString();
				...
				<ul class="dropdown-menu">
					...
					<li>
						<a href="javascript:logoutCompany();">
							<i class="fa fa-key"></i><%=ss_com_id %> 로그아웃
						</a>
					</li>
				</ul>
			</li>
...
<div class="page-container">
	...
	<div class="page-sidebar navbar-collapse collapse">
		...
		<ul class="page-sidebar-menu hidden-sm hidden-xs" data-auto-scroll="true" data-slide-speed="200" style="display:none;">
			<li>
