...
if(sProduct_id.equals("")) {
	response.sendRedirect("/jsp/admin/product/product_list.jsp");
}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------				
		getProductOrderAllList('<%=sProduct_id%>');
...
%>							
				<li class="classic-menu-dropdown active">
					<a href="/jsp/admin/product/product_list.jsp">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					ORDER List [<%=sProduct_title %>]<small> 제품에 대한 태권도장/옵션 별 주문 정보입니다.</small>
					</h3>
				...
				<div class="col-md-6-ws1">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>선택옵션별 전체주문 목록
							</div>
						</div>					
						<div class="portlet-body">
							...
							<tr>
								<th class="hidden-xs">
									<i class="fa fa-check"></i> ID
								</th>
								<th>
									<i class="fa fa-gift"></i> 태권도장
								</th>	
								<th class="hidden-xs">
									<i class="fa fa-arrows"></i> 옵션ID
								</th>															
								<th>
									<i class="fa fa-arrows"></i> 옵션명
								</th>
								<th>
							...
							<tbody id="product_order_list_tbody" >
