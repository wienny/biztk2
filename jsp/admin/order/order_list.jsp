...
String sProduct_id = request.getParameter("p_product_id")== null ? "": request.getParameter("p_product_id").toString();

if(ss_com_id.equals("")) {	
	response.sendRedirect("/");
}

if(sProduct_id.equals("")) {
...
sProduct_title = recP.get("product_title", "");
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//----------------------
		// 사용자 주문 리스트 조회 . 페이지 로딩 시 최초 1회. ajax call 
		//----------------------				
		getUserOrderList('<%=sProduct_id%>');

		//----------------------
		// 사용자 주문 리스트 조회. ajax call 
		//----------------------
		getUserOrderBySizeList('<%=sProduct_id%>','<%=ss_com_id%>');				
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					ORDER List [<%=sProduct_title %>]<small> 제품에 대한 학부모님들의 선택 정보입니다.</small>
					</h3>
             ...
             <div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
                 <div class="modal-dialog">
                     <div class="modal-content">
                         <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                             <h4 class="modal-title">주문정보 수정</h4>
                         </div>
                         <div class="modal-body">
                              수정 기능 준비 중.....
                         </div>
				...
				<div class="col-md-6-ws1">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>사용자 주문 목록
							</div>
						</div>					
						<div class="portlet-body">
							...
							<tr>
								<th>
									<i class="fa fa-users"></i> 학생
								</th>
								<th class="hidden-xs">
									<i class="fa fa-user"></i> 학부모
								</th>
								<th>
									<i class="fa fa-arrows"></i> 선택옵션
								</th>
								<th>
									<i class="fa fa-shopping-cart"></i> 수량
								</th>
								<th class="hidden-xs">
									<i class="fa fa-calendar"></i> 등록일자
								</th>
								<th class="hidden-xs">
									<i class="fa fa-gears"></i> 정보수정
								</th>																
								
							</tr>
							</thead>
							<tbody id="user_order_list_tbody" >
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>선택옵션별 주문 목록
							</div>
						</div>					
						<div class="portlet-body">
							<table class="table table-striped table-bordered table-advance table-hover">
							...
							<tbody id="company_order_list_tbody" >
									...
									<div class="row">
										<div class="col-md-8">
											<div class="col-md-offset-7 col-md-9">
												<div type="button" class="btn blue" id="order_company" onclick="setOrderCompany('<%=sProduct_id%>','<%=ss_com_id%>');">주문 확정</div>
